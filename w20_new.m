...
%-- import data, set-up
%==========================================================================
load('MTS_Wgn20_Pc_150_Axial.mat');

% new time vector [s]
t_new = 0.12 : 0.10 : 9363.5;
t     = t_new(1:85220);
%t     = t_new(1:85720);

% shorten vectors
Displacement = Displacement(1:85220);
diffStress = diffStress(1:85220);
...
%-- noise
n_min   = min(diffStress(1:5500));
n_max   = max(diffStress(1:5500));
n_range = n_max - n_min;
...
% legend('data','lsq-fit')
% title(['Wgn 20 (first k removed), r = ',num2str(r_edit(2))])
...
% legend('data','lsq-fit')
% title(['Wgn 20 (first, last k removed), r = ',num2str(r_edit2(2))])
...
% legend('data','lsq-fit')
% title(['Wgn 20 (first 2 k removed), r = ',num2str(r_edit3(2))])
...
% legend('data','lsq-fit')
% title(['Wgn 20 (outlier k removed), r = ',num2str(r_edit4(2))])
