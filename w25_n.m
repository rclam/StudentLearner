...
%-- import data, set-up
%==========================================================================
load('MTS_Wgn25_Pc_150_Axial.mat');

% new time vector [s]
t_new = 0.12 : 0.10 :  1.6592e+04;
t     = t_new;

% shorten vectors
Displacement = Displacement(1:165919);
diffStress = diffStress(1:165919);
...
%-- noise
n_min   = min(diffStress(1:270));
n_max   = max(diffStress(1:270));
n_range = n_max - n_min;
...
% legend('data','lsq-fit')
% title(['Wgn 25 (first k removed), r = ',num2str(r_edit(2))])
...
% legend('data','lsq-fit')
% title(['Wgn 25 (first, last k removed), r = ',num2str(r_edit2(2))])
...
% legend('data','lsq-fit')
% title(['Wgn 25 (first 2 k removed), r = ',num2str(r_edit3(2))])
% 
