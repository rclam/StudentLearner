...
%-- import data, set-up
%==========================================================================
load('MTS_Wgn24_Pc_150_Axial.mat');

% new time vector [s]
t_new = 0.12 : 0.10 : 8735;
t     = t_new(1:87000);

% shorten vectors
Displacement = Displacement(1:87000);
diffStress = diffStress(1:87000);
...
%-- noise
n_min   = min(diffStress(1:100));
n_max   = max(diffStress(1:100));
n_range = n_max - n_min;
...
% legend('data','lsq-fit')
% title(['Wgn 24 (first k removed), r = ',num2str(r_edit(2))])
...
% legend('data','lsq-fit')
% title(['Wgn 24 (first, last k removed), r = ',num2str(r_edit2(2))])
...
% legend('data','lsq-fit')
% title(['Wgn 24 (first 2 k removed), r = ',num2str(r_edit3(2))])
