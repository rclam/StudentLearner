...
%-- import data, set-up
%==========================================================================
load('MTS_Wgn21_Pc_150_Axial.mat');

% new time vector [s]
t_new = 0.12 : 0.10 : 12024;
t     = t_new(1:111000);

% shorten vectors
Displacement = Displacement(1:111000);
diffStress = diffStress(1:111000);
...
%-- noise
n_min   = min(diffStress(1:500));
n_max   = max(diffStress(1:500));
n_range = n_max - n_min;
...
% legend('data','lsq-fit')
% title(['Wgn 21 (first k removed), r = ',num2str(r_edit(2))])
...
% legend('data','lsq-fit')
% title(['Wgn 21 (first, last k removed), r = ',num2str(r_edit2(2))])
% 
...
% legend('data','lsq-fit')
% title(['Wgn 21 (first 2 k removed), r = ',num2str(r_edit3(2))])
% 
%-- remove outlier?
% drops(:,4) = [];
% net_Dd(:,4)=[];
...
% legend('data','lsq-fit')
% title(['Wgn 21 (outlier k removed), r = ',num2str(r_edit4(2))])
