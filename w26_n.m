...
%-- import data, set-up
%==========================================================================
load('MTS_Wgn26_Pc_150_Axial.mat');

% new time vector [s]
t_new = 0.12 : 0.10 : 15285;
t     = t_new(1:149500);

% shorten vectors
Displacement = Displacement(1:149500);
diffStress = diffStress(1:149500);
...
%-- time step
ts = Time(2) - Time(1);
fprintf('Sample rate is: %.2f seconds\n', ts)
...
% legend('data','lsq-fit')
% title(['Wgn 26 (first k removed), r = ',num2str(r_edit(2))])
...
% legend('data','lsq-fit')
% title(['Wgn 26 (first, last k removed), r = ',num2str(r_edit2(2))])
% 
